...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.confirm = function (text, callbackOk, callbackCancel, title) {
            return app.modal({
                text: text || '',
        ...
        app.prompt = function (text, callbackOk, callbackCancel, inputType) {
            var type = inputType || 'text';
            var reg = (inputType === 'number') ? ' pattern="[0-9]*"' : '';
            return app.modal({
                text: text || '',
                title: app.params.modalTitle || '',
                afterText: '<input type="'+type+'" '+reg+' class="modal-prompt-input">',
                buttons: [
